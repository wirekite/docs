...
- **Cross Database**- Wirekite allows you to move data from Oracle, Postgres, MySQL and SQL Server to multiple cloud databases. For now we are supporting Cloud versions of MySQL and Postgres, Snowflake, Firebolt, Singlestore. We will be adding more Cloud targets in future.
