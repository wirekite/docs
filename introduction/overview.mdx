...
A mature data infrastrcuture usuallu have two components - A production OLTP database which serves the production application, and a secondary Data Warehouse / Analytics database which can be used by the analytic applications. 