...
There can be a multitude of reasons that data needs to be moved from one databases platform to another. But the most common reasons that it happens are these 2
