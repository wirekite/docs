...
<Icon icon="tachometer-fastest" size={32} /> **Performant** - We pride ourselves in being extremely fast. Please visit our [benchmarks](https://wirekite.webflow.io/).
...
<Card title="Petabytes" icon="truck-moving">
