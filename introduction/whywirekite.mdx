...
<Tip>
  The data transfer rate is not limited by the network but rather the rate at which extraction and loading of data occurs on the source and target database respectively.
</Tip>
