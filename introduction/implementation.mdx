...
<Steps>
  <Step title="Schema">
    <CardGroup cols="3">
      <Card title="Schema Extractor" icon="paintbrush" horizontal={false} href="/introduction/architecture">
        Extract the Schema of your source database. One Time.
      </Card>

      <Card title="Schema Mover" icon="paintbrush" horizontal={false} href="/introduction/architecture">
        Move the Schema from source to target database. One Time.
      </Card>

      <Card title="Schema Loader" icon="square-code" horizontal={false} href="/introduction/architecture">
