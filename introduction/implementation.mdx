...
<Steps>
  <Step title="Schema">
    <CardGroup cols="3">
      <Card title="Schema Extractor" icon={1} iconType="solid" horizontal={false} href="/introduction/architecture">
        Extract the Schema of your source database. One Time.
      </Card>

      <Card title="Schema Mover" icon={2} iconType="solid" horizontal={false} href="/introduction/architecture">
        Move the Schema from source to target database. One Time.
      </Card>

      <Card title="Schema Loader" icon={3} iconType="solid" horizontal={false} href="/introduction/architecture">
  ...
  <Step title="Data">
    <CardGroup cols="3">
      <Card title="Data Extractor" icon={4} iconType="solid" href="/introduction/architecture">
        Extract the Data of your source database. One Time.
      </Card>

      <Card title="Data Mover" icon={5} iconType="solid" href="/introduction/architecture">
        Move the Data from source to target database. One Time.
      </Card>

      <Card title="Data Loader" icon={6} iconType="solid" href="/introduction/architecture">
  ...
  <Step title="Change">
    <CardGroup cols="3">
      <Card title="Change Extractor" icon={7} iconType="solid" href="/introduction/architecture">
        Extract the Changes from your source database. Continuous.
      </Card>

      <Card title="Change Mover" icon={8} iconType="solid" href="/introduction/architecture">
        Move the Change files from source to target database. Continuous.
      </Card>

      <Card title="Change Loader" icon={9} iconType="solid" href="/introduction/architecture">
